...
namespace 查重工具.JJCommon
{
    ...
    /// MySqlHelper操作类
    /// </summary>
    public class JJMySQLHelper
    {
        public static readonly string str_con = "server=49.233.40.109;uid=root;pwd=111111";
        ...
        public JJMySQLHelper(string connectionString)
        {
            this.ConnectionString = connectionString;
        }
        public JJMySQLHelper()
        {
            this.ConnectionString = str_con;
        }
        /// <summary>
        /// 数据库连接字符串
        /// </summary>
