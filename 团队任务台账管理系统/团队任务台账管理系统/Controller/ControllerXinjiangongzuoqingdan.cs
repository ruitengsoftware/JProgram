   ...
   public class ControllerXinjiangongzuoqingdan
    {
        ...
        public bool SaveGongzuoqingdan(JJQingdanInfo renwu)
        {
            ...
            //保存任务
            str_sql = $"insert into jjrenwu values('{renwu._renwumingcheng}','{JJPersonInfo._shiming}','{renwu._zhubanren}','{renwu._wanchengshijian}',0,'{renwu._xiangxian}','{renwu._chuangjianshijian}')";
