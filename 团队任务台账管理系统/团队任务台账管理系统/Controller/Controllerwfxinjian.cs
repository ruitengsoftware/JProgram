...
namespace 团队任务台账管理系统.Controller
{
    public class Controllerwfxinjian
    {
        ...
        {
            string str_sql = $"insert into jjtask values(@task,@jinjichengdu,@jutiyaoqiu,@fenjie,@jinzhan,@shuifuze,@shuipizhun,@zixunshui,@tongzhishui,@shixian,@beizhu,@zhuangtai,@yidu)";
            int num = mysqlhelper.ExecuteNonQuery(str_sql, new MySql.Data.MySqlClient.MySqlParameter[] {
