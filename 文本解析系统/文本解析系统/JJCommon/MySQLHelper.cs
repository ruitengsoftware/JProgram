...
namespace 文本解析系统.JJCommon
{
    ...
    {
        public static readonly string str_connperson= System.Configuration.ConfigurationManager.ConnectionStrings["connstrperson"].ToString();
        public static readonly string str_connother = System.Configuration.ConfigurationManager.ConnectionStrings["connstrother"].ToString();
        ...
        public MySQLHelper()
        {
            this.ConnectionString = System.Configuration.ConfigurationManager.ConnectionStrings["connstrperson"].ConnectionString.ToString();
        }
        /// <summary>
        /// 数据库连接字符串
        /// </summary>
