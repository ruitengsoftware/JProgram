...
namespace 谦海数据解析系统.JJwinform
{
    public partial class NewBQForm : Form
    {
        ...
        /// 需要创建的标签的父节点信息
        /// </summary>
        public BiaoqianInfo _parentInfo = null;
        /// <summary>
        /// 属于窗体本身的标签信息
        /// </summary>
        public BiaoqianInfo _tagInfo = null;

        public NewBQForm()
        {
            InitializeComponent();
        }
        public NewBQForm(BiaoqianInfo bqi)
        {
            InitializeComponent();
        ...
        private void NewBQForm_Load(object sender, EventArgs e)
        {
            ...
            if (_tagInfo != null)
            {
                ...
                foreach (Control c in panel_neirong.Controls)
                {
                    ...
                    if (c is CheckBox && _tagInfo._biaoqianRoot.list_neirong.Contains(c.Text))
                    {
                ...
                foreach (Control c in flp_weizhi.Controls)
                {
                    ...
                    if (c is CheckBox && _tagInfo._biaoqianRoot.list_position.Contains(c.Text))
                    {
                        (c as CheckBox).Checked = true;
                    }
                }
                foreach (Control c in flp_pipeidu.Controls)
                {
                    ...
                    if (c is CheckBox && _tagInfo._biaoqianRoot.list_pipei.Contains(c.Text))
                    {
                        (c as CheckBox).Checked = true;
                    }
                }
                ...
                foreach (Control c in flp_yupian.Controls)
                {
                    ...
                    if (c is CheckBox && _tagInfo._biaoqianRoot.list_yupian.Contains(c.Text))
                    {
                        (c as CheckBox).Checked = true;
                    }
                }
                tb_shunshu.Text = _tagInfo._biaoqianRoot.shunshu.ToString();
                tb_daoshu.Text = _tagInfo._biaoqianRoot.daoshu.ToString();
                tb_gudingzhi.Text = _tagInfo._biaoqianRoot.gudingzhi;
                tb_jushouzhi.Text = _tagInfo._biaoqianRoot.jushouzhi;
                tb_juzhongzhi.Text = _tagInfo._biaoqianRoot.juzhongzhi;
                tb_juweizhi.Text = _tagInfo._biaoqianRoot.juweizhi;
                tb_weizhiqian0.Text = _tagInfo._biaoqianRoot.weizhiqian0;
                tb_weizhiqian1.Text = _tagInfo._biaoqianRoot.weizhiqian1;
                tb_weizhihou0.Text = _tagInfo._biaoqianRoot.weizhihou0;
                tb_weizhihou1.Text = _tagInfo._biaoqianRoot.weizhihou1;
                tb_zhengzetiqu.Text = _tagInfo._biaoqianRoot.zhengzetiqu;
        ...
        private void lbl_baocun_Click(object sender, EventArgs e)
        {
            ...
            BiaoqianRoot _bqRoot = new BiaoqianRoot()
            {
        ...
        public void SaveBiaoqianInfo()
        {
            ...
            str_sql = $"insert into 数据解析库.内容标签表 " +
                ...
                $"'{_tagInfo._fubiaoqianming}','{_tagInfo._biaoqianSet}'," +
