...
namespace WindowsFormsApp1.UC
{
    ...
    public partial class UCChachong : UserControl
    {
        ...
        private void UCChachong_Load(object sender, EventArgs e)
        {
            ...
            cbb_geshi.Items.AddRange(format.ToArray());
            try
            {
            ...
            string[] arr_shtname = _mycontroller.GetTablesName();
        ...
        private void lbl_addtask_Click(object sender, EventArgs e)
        {
            ...
            if (mywinform.ShowDialog() == DialogResult.OK)
            {
                ...
                for (int i = 0; i < list_files.Count; i++)
                {
                    ...
                    t = new Thread(new ParameterizedThreadStart(AddControl));
                    t.Start(o);
        ...
        public void AddControl(object o)
        {
            ...
            {
                Action<object> a = AddControl;
                this.BeginInvoke(a, o);
            }
            else
            {
                List<object> list = o as List<object>;
                Panel p = list[0] as Panel;
                Control c = list[1] as UserControl;
                p.Controls.Add(c);
            }
        ...
        private void Lbl_baocun_Click(object sender, EventArgs e)
        {
            ...
            string str_sql = $"insert into zhengwensetting (xuhao,geshimingcheng,zhengwenchachong,shanchu100,zhengwenchachongbiao," +
                $"zhengwenruku,zhengwenrukubiao,rizhilujing,shujukushai) values " +
                $"(1,'{formatname}'," +
            ...
            _mycontroller.SaveFormat(str_sql);
        ...
        {
            List<string> list_geshi = _mycontroller.GetFormat();
            cbb_geshi.Items.Clear();
            cbb_geshi.Items.AddRange(list_geshi.ToArray());
        }
    }
}
