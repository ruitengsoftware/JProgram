...
namespace BLL
{
    public class ControllerChachong
    {
        ...
        {
            //string str_sql = @"select distinct 格式名称 from 软件设置表";
            ...
            //    list_string.Add(dic["格式名称"].ToString());
            //}

            List<string> arr_format = chhelper.GetFormatsName("zhengwensetting");
        ...
        public Dictionary<string, object> GetSetting(string formatname)
        {
            ...
            dic.Add("数据库筛", mydr["shujukushai"].ToString());
            try
            {
