...
namespace WindowsFormsApp1.Controller
{
    public class ControllerClickhouse
    {
        ...
        /// </summary>
        /// <returns></returns>
        public List<string> GetFormatsName(string n)
        {
            List<string> listtablename = new List<string>();
            ...
            try
            {
                ...
                string dbfile = $"select geshimingcheng from {n}";
                var dt = GetDataFromTable(dbfile);
                for (int i = 0; i < dt.Rows.Count; i++)
                {
        ...
        //腾讯云的 119.45.47.2
        //阿里云39.107.125.33
        string str_connectionn = $"Compress=True;Host={Properties.Settings.Default._ip};Port=9000;User=default;Password=;Database=default;";
